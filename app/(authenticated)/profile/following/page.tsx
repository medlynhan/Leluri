...
import { useGetFollowing } from '../../../lib/client-queries/userfollowers';
...
export default function FollowingPage(){
  ...
  const { data: pageData = [], isLoading, isFetching } = useGetFollowing(userId, { page, limit });
  ...
  return (
    <div className="max-w-xl mx-auto p-6 space-y-4">
      <h1 className="text-xl font-semibold mb-4">Mengikuti</h1>
      {isLoading && loadingSkeleton}
      {!isLoading && all.length === 0 && <p className="text-sm text-[var(--dark-grey)]">Belum mengikuti siapapun.</p>}
